...
export default class Upcoming extends React.Component {
  ...
  componentDidMount() {
    return fetch('https://api.themoviedb.org/3/movie/upcoming?api_key=15e642b68f26e9ec302bcdc82db26ec4&language=en-US&page='+this.state.page)
  ...
  loadMorePage(){
    ...
    return fetch('https://api.themoviedb.org/3/movie/upcoming?api_key=15e642b68f26e9ec302bcdc82db26ec4&language=en-US&page='+page)
      .then((response) => response.json())
      .then((responseJson) => {
        this.setState({
          isLoading: false,
